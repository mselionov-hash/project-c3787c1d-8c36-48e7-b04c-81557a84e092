...
export function generateLoanPDF(loan: LoanPDFData) {
  ...
  addWrappedText('3.1. Передача денежных средств осуществляется посредством банковского перевода на реквизиты Заемщика либо иным способом, согласованным сторонами.');
