...
export function generateLoanPDF(loan: LoanPDFData) {
  ...
  addWrappedText('3.1. Передача денежных средств осуществляется через Систему Быстрых Платежей (СБП) либо иным способом, согласованным сторонами.');
  addWrappedText(`3.2. Назначение платежа: Перевод по договору займа № ${loanNumber}.`);
