...
export function generateLoanPDF(loan: LoanPDFData) {
  ...
  addWrappedText('3.1. Передача денежных средств осуществляется посредством банковского перевода через Систему Быстрых Платежей (СБП) либо иным способом, согласованным сторонами.');
