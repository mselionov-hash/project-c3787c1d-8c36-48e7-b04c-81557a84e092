...
const FORBIDDEN_MARKERS: RegExp[] = [
  /\[нет записей в секции\s+\w+\]/gi,
  /\[данные секции\s+\w+\s+не предоставлены\]/gi,
  /\[реквизит[ы]?\s+.*?из APP1\]/gi,
  /\[см\.\s*Приложение\s*№?\s*\d+\]/gi,
  /\[не указано\]/gi,
  /\[не опубликован\]/gi,
  /\[ожидается подписание\]/gi,
  /\[—\]/g,
  /_{5,}/g,
  /—\s*\(Europe\/Moscow\)/g,
  /Europe\/Moscow/g,
  /\[реквизиты не указаны\]/gi,
  /\[график платежей не сформирован\]/gi,
  /\[подпись не проставлена\]/gi,
  /время не зафиксировано/gi,
];
