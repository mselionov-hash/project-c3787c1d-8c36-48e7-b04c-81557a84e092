...
5.1. Настоящая Расписка составлена в электронной форме и действительна при подписании УКЭП Заемщика.

5.2. Телефон, адрес электронной почты и ID учетной записи на Платформе используются для идентификации учетной записи, направления уведомлений и связывания действий в журнале событий Платформы с владельцем учетной записи, но не заменяют УКЭП как юридически значимый реквизит подписи.
